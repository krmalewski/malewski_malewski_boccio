$(document).ready(function() {
  ...
  var stickyNav = function(){
    ...
    // if we've scrolled more than the navig∂ation, change its position to fixed to stick to top,
	...
	// Toggle mobile nav bar on click
	$('#nav-toggle').on('click', function() {
	  this.classList.toggle('active');
	  $('.nav')[0].classList.toggle('active');
	  $('.nav-list')[0].classList.toggle('active');
	});
